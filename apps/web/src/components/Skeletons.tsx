...
export function MetricCardSkeleton() {
  return (
    <div className="flex-[1_1_200px] rounded-lg border border-black/[.06] dark:border-white/[.08] bg-card px-5 py-[18px] shadow-[var(--shadow-card)] animate-pulse" />
  )
}
...
export function DealsListSkeleton({ rows = 6 }: { rows?: number }) {
  return (
    <div className="flex-1 bg-card border border-black/[.06] dark:border-white/[.08] rounded-lg shadow-[var(--shadow-card)] overflow-hidden">
...
function KanbanColumnSkeleton({ cards = 2 }: { cards?: number }) {
  return (
    <div className="w-[252px] shrink-0 flex flex-col rounded-lg border border-black/[.07] dark:border-white/[.08] bg-surface-alt overflow-hidden">
      {/* column header */}
      <div className="px-3.5 py-3 shrink-0 border-b border-black/[.06] dark:border-white/[.08] bg-card/60 flex items-center gap-2">
      ...
      <div className="flex flex-col gap-2 p-2.5">
        {Array.from({ length: cards }).map((_, i) => (
          <div key={i} className="rounded-lg p-3.5 bg-card border border-black/[.08] dark:border-white/[.08] flex flex-col gap-2.5">
...
export function DealDetailSkeleton() {
  return (
    <div className="flex flex-col gap-4 pb-4">
      {/* header card */}
      <div className="bg-card border border-black/[.06] dark:border-white/[.08] rounded-lg p-5 shadow-[var(--shadow-card)]">
