    ...
    <div className="p-1 pt-2">
      <div className="relative w-[128px] h-[128px] group">
        ...
        <button
          ...
          className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-white dark:bg-secondary border border-black/[.12] dark:border-white/[.15] flex items-center justify-center text-slate-400 hover:text-slate-700 dark:hover:text-white opacity-0 group-hover:opacity-100 transition-opacity shadow-sm"
...
export function PastePreviewModal({ text, onClose }: PastePreviewModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-card rounded-xl shadow-2xl border border-black/[.08] dark:border-white/[.08] w-[86vw] max-w-[720px] max-h-[80vh] flex flex-col animate-in fade-in-0 zoom-in-95 duration-150"
