...
export enum LeadSegmentOption {
  IdeaRichFounder = 'Idea-Rich Founder',
  SmeGoingDigital = 'SME Going Digital',
  CorporateInnovator = 'Corporate Innovator',
  PhStartupScaleUp = 'PH Startup/Scale-up',
}

export const LEAD_SEGMENT_OPTIONS = [
  { value: LeadSegmentOption.IdeaRichFounder, label: 'Idea-Rich Founder' },
  { value: LeadSegmentOption.SmeGoingDigital, label: 'SME Going Digital' },
  { value: LeadSegmentOption.CorporateInnovator, label: 'Corporate Innovator' },
  { value: LeadSegmentOption.PhStartupScaleUp, label: 'PH Startup/Scale-up' },
] as const
...
export const STANDARD_INDUSTRY_OPTIONS = [
  { value: 'Agriculture', label: 'Agriculture' },
  { value: 'Automotive', label: 'Automotive' },
  { value: 'Banking & Finance', label: 'Banking & Finance' },
  { value: 'BPO / Outsourcing', label: 'BPO / Outsourcing' },
  ...
  { value: 'F&B / Food Service', label: 'F&B / Food Service' },
  ...
  { value: 'IT Services / IT Solutions', label: 'IT Services / IT Solutions' },
  ...
  { value: 'Technology / Tech Startup', label: 'Technology / Tech Startup' },
...
export const INDUSTRY_OPTIONS = STANDARD_INDUSTRY_OPTIONS.map(option => option.value)
...
export const COMMAND_ROUTES = [
  ...
  { label: 'Recordings', path: '/recordings',  keywords: ['recordings', 'audio', 'uploads'] },
